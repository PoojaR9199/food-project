                ...
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item">
                    ...
                    <li class="nav-item">
                       ...
                       <%-- <sup><span class="badge" style="color: black;
    background-color: coral;" id="pcount" runat="server"></span></sup>--%>
                  ...
                  <li class="nav-item" id="btnloginsignup" runat="server">
        ...
        <div class="cat">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="login.aspx" style="margin-left:200px;font-size:20px"><strong>HERE IS OUR NEW FEATURE...Customized-cake! (click here..)</strong></a>
                </li>
              </ul>  
            </div>
        </div>
          ...
          <div class="row p-0 m-0">
            <div class="one col-lg-4 col-md-12 col-12 p-0">
              ...
              <div class="details">
               ...
               <button class="text-uppercase"><a id="acr" href="login.aspx" style="text-decoration:none;color:black">Order Now</a></button> 
              </div>
            </div>
            <div class="one col-lg-4 col-md-12 col-12 p-0">
      ...
      <div class="product text-center col-lg-3 col-md-4 col-12">
        ...
        <section id="banner" class="my-5 py-5">
          <div class="container">
            ...
            <a href="login.aspx" id="acr"><button class="text-uppercase">Order Now</button></a>
          </div>        
        </section>
