<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="productview3.aspx.cs" Inherits="productview3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="container sproduct my-5 pt-5">    <div class="row mt-5">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                            ...
                            style="font-size: 0.8rem;
                               font-weight: 700;
                                outline: none;
                                 ...
                                 padding: 13px 30px;
                                   cursor: pointer;
                                    text-transform: uppercase;" OnClick="btnaddtocart_Click"/>
                    ...
                    <p style="font-size:12px"><%#Eval("pdesc")%></p>
